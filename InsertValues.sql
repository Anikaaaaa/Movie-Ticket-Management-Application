use MovieTicketBookingAssignment;
...
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(1,16,'2023-01-23','03:30:00',150,1,1)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(2,2,'2023-01-20','03:30:00',200,2,2)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(3,10,'2023-01-21','02:30:00',300,3,1)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(4,10,'2023-01-23','10:30:00',400,1,3)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(5,0,'2023-01-01','10:30:00',0,1,null)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(6,2,'2023-01-02','03:30:00',200,2,5)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(7,10,'2023-01-03','02:30:00',300,1,6)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(8,10,'2023-01-04','10:30:00',400,1,8)
INSERT INTO show(show_id,booked_seats,show_date,start_at,ticket_price,cinema_hall_id,movie_id) VALUES(9,0,'2023-01-05','10:30:00',0,1,7)
